...
try {
    ...
    (0, node_child_process_1.execSync)(`npx prisma migrate dev --schema=../prisma/schema.prisma --name create_table`, {
        stdio: 'inherit',
        cwd: root,
    });
...
const userData = [
    {
        ...
        userWallet: "100000",
        userPassword: bcrypt_1.default.hashSync("fanantenana", salt),
    ...
    },
    {
        ...
        userPassword: bcrypt_1.default.hashSync("andrialova", salt),
    },
];
const videoId = {
    vadiko: `Vadiko`,
...
const directData = [
    ...
    },
    {
        ...
        directDescription: "Une formation proposée par l'entrepreneur Mianatra Mahomby à propos de vente. Elle est destinée aux personnes qui ont envie de devenir professionel dans le domaine du vente !",
        directPrice: "10000",
