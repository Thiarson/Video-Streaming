...
module.exports = (app) => {
    ...
    app.get("/data/*", (req, res) => {
        try {
            ...
            res.sendFile(node_path_1.default.join(server, 'index.html'));
        }
    });
    app.get("/", (req, res) => {
        res.sendFile(node_path_1.default.join(server, 'index.html'));
    ...
    app.get("/static/js/*", (req, res) => {
        try {
            const js = node_path_1.default.join(server, req.url);
    ...
    app.get("/static/css/*", (req, res) => {
        try {
            const css = node_path_1.default.join(server, req.url);
    ...
    app.get("/manifest.json", (req, res) => {
        res.sendFile(node_path_1.default.join(server, req.url));
    });
    app.get("/favicon.ico", (req, res) => {
        const faviconPath = node_path_1.default.join(server, req.url);
