...
const BuyVideo: FC = () => {
  ...
  const contentTitle = video.videoTitle
  const contentPrice = video.videoPrice
  ...
  const buy = () => {
    ...
    const userMoney = parseFloat(user.userWallet)
    const price = parseFloat(contentPrice)
      ...
      <div className="w-full h-full flex flex-col justify-center items-center">
        ...
        <div className=" bg-zinc-900 px-12 pt-6 pb-8 rounded-b-md relative overflow-y-scroll scrollbar-hide">
          <div className="flex flex-col gap-4">
            <h1 className=" text-center text-xl">Achat de {contentTitle} : {contentPrice} Ar</h1>
