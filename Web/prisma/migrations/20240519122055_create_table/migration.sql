...
CREATE TABLE "UserInfo" (
    ...
    "userPhoto" VARCHAR NOT NULL DEFAULT '/data/default/profil/photo.jpg',
...
CREATE TABLE "VideoPlaylist" (
    ...
    CONSTRAINT "VideoPlaylist_pkey" PRIMARY KEY ("playlistId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "VideoPlaylist_playlistId_key" ON "VideoPlaylist"("playlistId");
